                     ...
                     <div className="col-lg-6 col-md-12">
                        <div className="tp-fun-fact-content">
                           <div className="tp-fun-fact-title-wrapper">
                              ...
                              <p>
                                 Rizcordix Global Pvt Ltd offers a range of IT services designed to foster innovation and growth. Our team delivers high-quality solutions across multiple sectors.
                              </p>
                              <ul>
                                 <li>
                                    <span> <GreenRightArrow /></span>
                                    Specializing in UI/UX design, app development, and branding solutions.
                                 </li>
                                 <li>
                                    <span><GreenRightArrow /> </span>
                                    Providing expert animation, video editing, and digital transformation services.
                                 </li>
                              </ul>
